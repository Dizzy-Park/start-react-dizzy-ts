...
const loadingSlice = createSlice({
  ...
  initialState,
  reducers: create => ({
    rdxSetLoading: create.reducer(
      (state: ILoadingState, action: PayloadAction<boolean>) => {
        state.isLoading = action.payload;
      }
    ),
    rdxSetLoadingMessage: create.reducer(
      (state: ILoadingState, action: PayloadAction<LoadingMessageType>) => {
        state.loadingMessage = action.payload;
      }
    ),
    rdxAddError: create.reducer(
      (state: ILoadingState, action: PayloadAction<string>) => {
        // 임시 경고 팝업
        alert(action.payload);
        return { ...state, errorMessage: action.payload };
      }
    ),
    rdxSetAreaLoading: create.reducer(
      (
        state: ILoadingState,
    ...
    rdxRemoveAreaLoading: create.reducer(
      (state: ILoadingState, action: PayloadAction<string>) => {
...
// dynamicMiddleware.addMiddleware(getLoadingMiddleware)
